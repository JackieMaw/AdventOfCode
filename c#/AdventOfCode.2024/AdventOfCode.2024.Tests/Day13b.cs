...
public class Day013b
{
    ...
    public void TestFullInput()
    {
        ...
        var expectedResult = 104140871044942;
...
*/
    private Point ParsePrizeLocation(string inputLine)
    {
        ...
        return new Point(prizeLocationParts[0] + 10000000000000, prizeLocationParts[1] + 10000000000000);
    }
    ...
    {        
        ...
        {
            var totalCost = costA * (long)A + costB * (long)B;
            Console.WriteLine($"    {A}x{costA} + {B}x{costB} = {totalCost}");
            return totalCost;
        }
        else
        {
    ...
    {
        return ((numClicks % 1) == 0) && (numClicks >= 0);
    }
