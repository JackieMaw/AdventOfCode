...
def get_all_settled(state):
    ...
    if len(settled) == 16:
        print(f"FINAL STATE REACHED! 16 have settled")
...
# SETUP FINAL STATE FROM FILE
raw_input = get_input(YEAR, DAY, "_final_b")
input_data = get_strings(raw_input)
#[[(3, 2), (3, 3), (3, 4), (3, 5)], [(5, 2), (5, 3), (5, 4), (5, 5)], [(7, 2), (7, 3), (7, 4), (7, 5)], [(9, 2), (9, 3), (9, 4), (9, 5)]]
final_state = get_initial_state(input_data) 

# TESTS
assert to_state_string(final_state) == "(3, 2)|(3, 3)|(3, 4)|(3, 5)#(5, 2)|(5, 3)|(5, 4)|(5, 5)#(7, 2)|(7, 3)|(7, 4)|(7, 5)#(9, 2)|(9, 3)|(9, 4)|(9, 5)"
assert final_state == from_state_string("(3, 2)|(3, 3)|(3, 4)|(3, 5)#(5, 2)|(5, 3)|(5, 4)|(5, 5)#(7, 2)|(7, 3)|(7, 4)|(7, 5)#(9, 2)|(9, 3)|(9, 4)|(9, 5)")
print("ALL TESTS PASSED")

# TEST INPUT DATA

assert execute(input_data) == 0
print("TEST INPUT PASSED - FINAL STATE")

raw_input = get_input(YEAR, DAY, "_test_b")
input_data = get_strings(raw_input)
assert execute(input_data) == 44169
