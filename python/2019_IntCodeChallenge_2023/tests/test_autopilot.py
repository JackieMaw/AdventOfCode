...
def test_juggler_one_item():
    ...
    assert commands == ['drop item1', 'east']
...
def test_juggler_two_items():
    ...
    commands = juggler.get_next_commands("Any room description")
    assert commands == ['drop item1', 'drop item2', 'east']

    commands = juggler.get_next_commands("Any room description")
    assert commands == ['drop item2', 'take item1', 'east']

    commands = juggler.get_next_commands("Any room description")
    assert commands == ['drop item1', 'take item2', 'east']