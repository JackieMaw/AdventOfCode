...
class InteractionHandler(OutputHandler, InputHandler):
    ...
    def receive(self):
        input_received = self._input_handler.receive()
    ...
    def send(self, int_code):
        ...
        self._output_handler.send(output_to_send)
    ...
    def create_fixed_input(fixed_input, basic_output = []):
        return InteractionHandler(input_handler=FixedInputHandler(fixed_input), output_handler=BasicOutputHandler(basic_output), ascii_enabled=False)